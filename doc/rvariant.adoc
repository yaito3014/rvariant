...
* [.candidate]#4)# @saki7 thinks the exact same implementation as the standard should work for constructing the `recursive_wrapper`-wrapped alternative with plain `T&&`. TODO: need confirmation; please implement it and see what happens.
