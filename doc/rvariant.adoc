...
* [.underline]#Let `T` denote an arbitrary type. If a user provides both `T` and `{recursive_wrapper}<T>` for the template parameter of `rvariant`, the program is ill-formed.#
